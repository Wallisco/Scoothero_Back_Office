...
1. Read the relevant spec section and existing code first.
2. Propose a short plan (files to touch, migrations, tests) and wait for approval before large changes.
3. Build on a branch, small commits, tests passing.
4. Finish with: what changed, how to test it on staging, anything left open.
